...
function getAuthEmailCopy(
    ...
    const copyByAction: Record<string, AuthEmailCopy> = {
        signup: {
            subject: 'Confirma tu cuenta en Sanate',
            title: 'Confirma tu correo',
            body: `${greeting}gracias por registrarte en Sanate. Confirma tu correo para activar tu cuenta y acceder al portal.`,
            ctaLabel: 'Confirmar cuenta'
        },
        recovery: {
            subject: 'Restablece tu contraseña en Sanate',
            title: 'Restablecer contraseña',
            body: `${greeting}recibimos una solicitud para restablecer tu contraseña. Usa el enlace para crear una nueva.`,
            ctaLabel: 'Restablecer contraseña'
        },
        magiclink: {
            subject: 'Tu enlace de acceso a Sanate',
            title: 'Iniciar sesión',
            body: `${greeting}usa este enlace para iniciar sesión en Sanate.`,
            ctaLabel: 'Iniciar sesión'
        },
        invite: {
            subject: 'Invitación a Sanate',
            title: 'Has sido invitado',
            body: `${greeting}te invitaron a unirte a Sanate. Acepta la invitación para continuar.`,
            ctaLabel: 'Aceptar invitación'
        },
        email_change: {
            subject: 'Confirma el cambio de correo en Sanate',
            title: 'Confirmar cambio de correo',
            body: `${greeting}confirma el cambio de correo de tu cuenta de Sanate.`,
            ctaLabel: 'Confirmar cambio'
        },
        email_change_new: {
            subject: 'Confirma tu nuevo correo en Sanate',
            title: 'Confirmar nuevo correo',
            body: `${greeting}confirma tu nueva dirección de correo en Sanate.`,
            ctaLabel: 'Confirmar correo'
        },
        reauthentication: {
            subject: 'Confirma tu identidad en Sanate',
            title: 'Verificación de seguridad',
            body: `${greeting}confirma tu identidad para continuar con esta acción en Sanate.`,
    ...
    return (
        copyByAction[emailActionType] ?? {
            subject: 'Acción requerida en Sanate',
            title: 'Continuar en Sanate',
...
export async function sendAuthEmail({
    ...
    const copy = getAuthEmailCopy(emailActionType, dbUser?.firstName);
