...
export default async function VideoDetailPage({
    ...
    try {
        ...
        const allVideos = await fetchVideos(video.category);
                                ...
                                {relatedVideos.map(related => (
                                    <Link
                                        ...
                                        <div className='relative flex h-16 w-24 shrink-0 items-center justify-center rounded-lg bg-muted'>
                                            <PlayCircle className='h-6 w-6 text-muted-foreground transition-colors group-hover:text-accent' />
                                        </div>

                                        {/* Info */}
                                        <div className='min-w-0 flex-1'>
                                            <p className='mb-1 line-clamp-1 text-sm font-medium text-foreground group-hover:text-accent'>
                                                {related.title}
                                            </p>
